			...
			<div className={styles.banner_wrapper}>
				<div className={styles.banner_left}>
					<div className={styles.banner_chip}>
						<span className={styles.banner_chip_text}>
							Explore the world!
						</span>
						<span className={styles.banner_chip_icon}>
							<svg
								width={24}
								height={25}
								viewBox="0 0 24 25"
					...
					<div className={styles.banner_text_content}>
						<h1 className={styles.heading}>
							Travel{" "}
							<span className={styles.pink_text}>
								top destination
							</span>{" "}
							of the world
						</h1>
						<p className={styles.banner_subHeading}>
							We always make our customer happy by providing as
							many choices as possible
						</p>
						<div className={styles.banner_buttons}>
							<a href="#" className={styles.get_started}>
								<span className={styles.get_started_text}>
									Get Started
								</span>
							</a>
							<a href="#" className={styles.demo_button}>
								...
								<span className={styles.demo_button_text}>
									Watch Demo
								</span>
							</a>
						</div>
